...
### Northern cardinal
![The northern cardinal was the most commonly observed species in Project FeederWatch! It is also the state bird for seven states. Photo credit: American Bird Conservancy.](northern_cardinal.jpeg){width="80%"}

### Dark-eyed junco
![The dark-eyed junco was the second most commonly observed species in Project FeederWatch in winter 2020-21. <br> Photo credit: Bob Vuxinic, submitted to Project FeederWatch](dark_eyed_junco_ProjectFeederwatch.png){width="80%"}
...
# Probably just need to do another select input
...
if (dim(state_bird_data_df)[1] < 1){
  ...
  labs(x="Longitude (E)", 
       ...
       subtitle = paste0(n_bird, " birds sighted in ", n_obs, " observations"),
       caption = "Data: Project FeederWatch") 
}
})
