...
data <- left_join(feederwatch, species_codes_dd, by = "species_code") %>%
  ...
  select(-loc_id, -entry_technique, -data_entry_method, -species_code, -valid, -sub_id, -obs_id, -proj_period_id, -pri_com_name_indxd:-category, -extinct:-taxon_code)   # remove columns that probably aren't interesting to the public
